    ...
    <div className="min-h-screen  pt-2 md:pt-0 relative bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
            ...
            <section className="  relative h-[30vh] sm:h-[45vh] md:h-[50vh] lg:h-[60vh] flex items-center justify-center text-center text-white overflow-hidden mb-8 sm:mb-12 pt-14 md:pt-0 ">
                ...
                >
                    ...
                    >
                        Take a visual tour of our vibrant juices, tasty snacks, and the lively atmosphere at Rainbow Juice & Snack Centre.
                    </motion.p>
                </motion.div>
            </section>  
            {/* <Laurels /> */}
       ...
       <section className="mx-auto px-4 pb-16 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
        {/* <div className="max-w-4xl mx-auto text-center">
          <BlurFade direction="up" offset={24}>
            <div className="text-center mb-12">
              <h2 className="md:text-4xl text-3xl font-semibold text-gray-800 font-serif mb-2 gallery-title">

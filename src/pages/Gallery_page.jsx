    ...
    <div className="min-h-screen  pt-2 md:pt-0 relative bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <section className="  relative h-[30vh] sm:h-[45vh] md:h-[50vh] lg:h-[60vh] flex items-center justify-center text-center text-white overflow-hidden mb-8 sm:mb-12 pt-14 md:pt-0 ">
        ...
        >
          ...
          >
            Take a visual tour of our vibrant juices, tasty snacks, and the
            lively atmosphere at Rainbow Juice & Snack Centre.
          </motion.p>
        </motion.div>
      </section>

      <section className="mx-auto px-4 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
            ...
            <div className="flex flex-1 flex-col gap-2">
              ...
              <div className="hidden md:flex flex-1 flex-row gap-2">
                ...
                <BlurFade
                  ...
                  delay={0.25}
                  offset={24}
                  className="hidden md:flex flex-1 flex-col  hover:shine"
                >
                  {/* img_03 */}
                  <img
                    className="object-cover h-full"
      ...
      <section className="mx-auto px-4 mt-2 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
        <div className="max-w-screen-2xl mx-auto  ">
          <div className="flex flex-col md:flex-row gap-2">
            {/* <BlurFade key={img.image || img.image || idx} delay={0.25 + idx * 0.05} inView> */}
            <div className="flex flex-1 flex-col gap-2">
      ...
      <section className="mx-auto px-4 mt-2 pb-16 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
        <div className="max-w-screen-2xl mx-auto  ">
          <div className="flex flex-col md:flex-row gap-2">
            {/* <BlurFade key={img.image || img.image || idx} delay={0.25 + idx * 0.05} inView> */}
            <div className="flex flex-1 flex-col gap-2">

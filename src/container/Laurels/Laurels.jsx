      ...
      <section className="mx-auto px-4 py-16 lg:py-24 relative bg-white">
        ...
        <div className="max-w-screen-2xl mx-auto mt-2  relative ">
          <div className="flex flex-col md:flex-row gap-2">
            ...
            <BlurFade direction="up" className="flex flex-1 flex-col  hover:shine" offset={24} inView delay={0.35}> 
            ...
            <div className="flex flex-1">
              ...
              <BlurFade direction="up"   inView delay={0.45} className="hover:shine"> 
                ...
                <BlurFade direction="up"  inView delay={0.55} className="hover:shine"> 
                ...
                <BlurFade direction="up"  inView delay={0.65} className="hover:shine"> 
                ...
                <BlurFade direction="up"   inView delay={0.75} className="hover:shine"> 

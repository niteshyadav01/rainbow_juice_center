...
const HeroSection = () => {
  ...
  const SplitLayout = ({ slide }) => (
    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-24 items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-4 sm:space-y-6 lg:space-y-8 text-left order-2 lg:order-1 hero-left-content hero-text-left">
        <BlurFade direction="up" offset={24} inView>
        ...
        <BlurFade direction="up" offset={24} inView>
          <div className="flex flex-col sm:flex-row gap-3 lg:gap-4 justify-center lg:justify-start">
            {slide.id === 2 ? (
              <>
                <a href="/menu" className="px-6 lg:px-8 py-3 lg:py-4 bg-gradient-to-r from-amber-600 via-orange-600 to-amber-700 text-white font-semibold rounded-2xl shadow-2xl flex items-center justify-center group backdrop-blur-sm">
                  <Play className="w-4 lg:w-5 h-4 lg:h-5 mr-2" />
                  Order Now
                </a>
                <a href="/menu" className="px-6 lg:px-8 py-3 lg:py-4 bg-amber-600 text-white font-semibold rounded-2xl flex items-center justify-center group shadow-lg">
              ...
              <>
               <a href="/menu"  className="px-6 lg:px-8 py-3 lg:py-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-semibold rounded-xl shadow-lg flex items-center justify-center group">
                  <Play className="w-4 lg:w-5 h-4 lg:h-5 mr-2" />
                  Order Now
                </a>
                <a href="/menu" className="px-6 lg:px-8 py-3 lg:py-4 border-2 border-amber-300 text-amber-800 font-semibold rounded-xl flex items-center justify-center">
                  <Sparkles className="w-4 lg:w-5 h-4 lg:h-5 mr-2" />
                  View Menu
                </a>
              </>
        ...
        <BlurFade direction="up" offset={24} inView>
          <div className="grid grid-cols-2 gap-4 lg:gap-8 max-w-sm mx-auto lg:mx-0">
          ...
          {slide.id === 2 ? (
            <div className="relative max-w-md mx-auto lg:max-w-none space-y-6">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white/20 backdrop-blur-md rounded-2xl lg:rounded-3xl overflow-hidden border border-white/30 shadow-2xl">
                  <img src={slide.mainImage} alt="Chocolate Milkshake" className="w-full h-80 sm:h-96 lg:h-[400px] object-contain" />
                  <div className="absolute top-4 lg:top-6 right-4 lg:right-6 bg-white/90 backdrop-blur-sm rounded-full px-3 lg:px-4 py-1 lg:py-2">
                    <div className="flex items-center justify-center">
                      <div className="w-2 lg:w-3 h-2 lg:h-3 bg-amber-500 rounded-full mr-2"></div>
              ...
              {slide.secondaryImage && (
                <div className="relative">
                  ...
                  <div className="relative bg-white/20 backdrop-blur-md rounded-xl lg:rounded-2xl overflow-hidden border border-white/30 shadow-xl">
                    <img src={slide.secondaryImage} alt="Additional Milkshake" className="w-full h-48 sm:h-56 lg:h-[280px] object-contain" />
              ...
              <div className="absolute -bottom-3 lg:-bottom-4 -right-3 lg:-right-4 w-16 lg:w-24 h-16 lg:h-24 bg-gradient-to-r from-amber-400 to-orange-400 rounded-full opacity-60"></div>
            </div>
          ) : (
            <div className="relative max-w-md mx-auto lg:max-w-none">
              ...
              <div className="relative bg-white/30 backdrop-blur-md rounded-2xl lg:rounded-3xl overflow-hidden border border-white/40 shadow-2xl">
                <img src={slide.mainImage} alt="Fresh Juices" className="w-full h-80 sm:h-96 lg:h-[500px] object-cover" />
                <div className="absolute top-4 lg:top-6 right-4 lg:right-6 bg-white/90 backdrop-blur-sm rounded-full px-3 lg:px-4 py-1 lg:py-2">
                  <div className="flex items-center">
                    <div className="w-2 lg:w-3 h-2 lg:h-3 bg-emerald-500 rounded-full mr-2"></div>
                    <span className="text-xs lg:text-sm font-semibold text-gray-800">{slide.badge}</span>
                  </div>
                </div>
                <div className="absolute bottom-4 lg:bottom-6 left-4 lg:left-6 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-lg lg:rounded-xl p-3 lg:p-4">
              ...
              <div className="absolute -bottom-3 lg:-bottom-4 -right-3 lg:-right-4 w-16 lg:w-24 h-16 lg:h-24 bg-gradient-to-r from-yellow-300 to-amber-400 rounded-full opacity-60"></div>
            </div>
          )}
        </div>
      </BlurFade>
    ...
    <div className="text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="space-y-6 lg:space-y-8 mb-8 lg:mb-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 justify-center">
          <button className="px-8 lg:px-10 py-4 lg:py-5 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-semibold rounded-xl lg:rounded-2xl shadow-lg flex items-center justify-center group">
            <Zap className="w-5 lg:w-6 h-5 lg:h-6 mr-2 lg:mr-3" />
            Order Now
          </button>
          <button className="px-8 lg:px-10 py-4 lg:py-5 border-2 border-amber-300 text-amber-800 font-semibold rounded-xl lg:rounded-2xl flex items-center justify-center">
      ...
      <div className="relative">
        <div className="relative mx-auto max-w-xs sm:max-w-md lg:max-w-lg">
          ...
          <div className="relative bg-white/30 backdrop-blur-md rounded-2xl lg:rounded-3xl overflow-hidden border border-white/40 shadow-2xl">
            <img src={slide.mainImage} alt="Healthy Drinks" className="w-full h-96 sm:h-[500px] lg:h-[600px] object-contain" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/10 to-transparent"></div>
          </div>

          {/* Floating Info Cards */}
          <div className="absolute -left-6 lg:-left-12 top-1/4 bg-white/90 backdrop-blur-sm rounded-lg lg:rounded-xl p-3 lg:p-4 shadow-lg transform -rotate-6">
          ...
          <div className="absolute -right-4 lg:-right-8 bottom-1/4 bg-amber-600 text-white rounded-lg lg:rounded-xl p-3 lg:p-4 shadow-lg transform rotate-6">
  ...
  const MosaicLayout = ({ slide }) => (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-8 items-start pt-8 md:pt-0">
        ...
        <div
          className="order-2 lg:order-1 lg:col-span-1 space-y-4 sm:space-y-6 mb-8 md:mb-0"
        ...
        >
          ...
          <div className="space-y-4">
            <a href="/contact" className="w-full px-6 py-4 bg-gradient-to-r from-rose-600 to-pink-600 text-white font-semibold rounded-xl shadow-lg flex items-center justify-center">
          ...
          <div className="grid grid-cols-2 gap-6 h-96">
            ...
            <div className="row-span-2 relative">
              ...
              <div className="relative h-full bg-white/20 backdrop-blur-md rounded-2xl overflow-hidden border border-white/30 shadow-xl">
                <img src={slide.mainImage} alt="Wellness Drinks" className="w-full h-full object-cover" />
            ...
            <div className="relative">
              ...
              <div className="relative h-full bg-white/20 backdrop-blur-md rounded-xl overflow-hidden border border-white/30 shadow-lg">
                <img src={slide.secondaryImage} alt="Fresh Ingredients" className="w-full h-full object-cover" />
            ...
            <div className="relative">
              ...
              <div className="relative h-full bg-white/20 backdrop-blur-md rounded-xl overflow-hidden border border-white/30 shadow-lg">
                <img src={slide.thirdImage} alt="Healthy Lifestyle" className="w-full h-full object-cover" />
  ...
  return (
    <>
      <div
        className={`relative min-h-content overflow-hidden md:pt-16 pt-8 bg-gradient-to-br ${currentSlideData.bgColor}`}
      >
        {/* Background Pattern */}
          ...
          <div className="flex space-x-3">
            {slides.map((_, index) => (
              <button
                ...
                className={`w-4 h-4 rounded-full ${index === currentSlide
        ...
        <div className="absolute bottom-0 left-0 w-full h-1 bg-white/20 overflow-hidden">
          <div
            className={`h-full bg-gradient-to-r from-${currentSlideData.primaryColor} to-${currentSlideData.secondaryColor} ${isTransitioning ? 'opacity-50' : 'opacity-100'}`}

...
const HeroSection = () => {
  ...
  const SplitLayout = ({ slide }) => (
    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-24 items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-4 sm:space-y-6 lg:space-y-8 text-left order-2 lg:order-1 hero-left-content hero-text-left">
        <div className={`inline-flex items-center px-4 lg:px-6 py-2 lg:py-3 rounded-full bg-gradient-to-r from-amber-100 to-orange-100 backdrop-blur-md text-amber-800 border border-amber-200 transition-all duration-700 hover:scale-105 ${isTransitioning ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
          <Heart className="w-4 lg:w-5 h-4 lg:h-5 mr-2 lg:mr-3 text-amber-600 animate-pulse" />
        ...
        <div className={`transition-all duration-700 delay-100 ${isTransitioning ? 'opacity-0 translate-y-8' : 'opacity-100 translate-y-0'}`}>
          <h1 className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-bold mb-4 lg:mb-6">
            <span className="block text-gray-800 mb-2 animate-fade-in-up">{slide.title}</span>
            <span className="block bg-gradient-to-r from-amber-600 via-orange-600 to-yellow-600 bg-clip-text text-transparent animate-fade-in-up delay-200">
              {slide.subtitle}
            </span>
          </h1>
          <p className="text-base sm:text-lg lg:text-xl text-gray-700 leading-relaxed mb-6 lg:mb-8 max-w-lg mx-auto lg:mx-0 animate-fade-in-up delay-300">
            {slide.description}
          </p>
        </div>
        ...
        <div className={`flex flex-col sm:flex-row gap-3 lg:gap-4 justify-center lg:justify-start transition-all duration-700 delay-200 ${isTransitioning ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
          {slide.id === 2 ? (
            <>
              <button className="px-6 lg:px-8 py-3 lg:py-4 bg-gradient-to-r from-amber-600 via-orange-600 to-amber-700 text-white font-semibold rounded-2xl shadow-2xl hover:shadow-amber-500/25 transform hover:scale-105 transition-all duration-300 flex items-center justify-center group backdrop-blur-sm animate-fade-in-up delay-400">
                <Play className="w-4 lg:w-5 h-4 lg:h-5 mr-2 group-hover:translate-x-1 transition-transform" />
                Order Now
              </button>
              <button className="px-6 lg:px-8 py-3 lg:py-4 bg-amber-600 text-white font-semibold rounded-2xl hover:bg-amber-700 transition-all duration-300 flex items-center justify-center group shadow-lg hover:scale-105 animate-fade-in-up delay-500">
            ...
            <>
              <button className="px-6 lg:px-8 py-3 lg:py-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center group animate-fade-in-up delay-400">
                <Play className="w-4 lg:w-5 h-4 lg:h-5 mr-2 group-hover:translate-x-1 transition-transform" />
                Order Now
              </button>
              <button className="px-6 lg:px-8 py-3 lg:py-4 border-2 border-amber-300 text-amber-800 font-semibold rounded-xl hover:bg-amber-50 transition-all duration-300 flex items-center justify-center hover:scale-105 animate-fade-in-up delay-500">
        ...
        <div className={`grid grid-cols-2 gap-4 lg:gap-8 max-w-sm mx-auto lg:mx-0 transition-all duration-700 delay-300 ${isTransitioning ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
          <div className="bg-white/70 backdrop-blur-sm rounded-xl lg:rounded-2xl p-3 lg:p-4 text-center border border-white/50 hover:scale-105 transition-transform duration-300 animate-fade-in-up delay-600">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-xl lg:rounded-2xl p-3 lg:p-4 text-center border border-white/50 hover:scale-105 transition-transform duration-300 animate-fade-in-up delay-700">
        ...
        {slide.id === 2 ? (
          <div className="relative max-w-md mx-auto lg:max-w-none space-y-6">
            ...
            <div className="relative animate-fade-in-up delay-400">
              ...
              <div className="relative bg-white/20 backdrop-blur-md rounded-2xl lg:rounded-3xl overflow-hidden border border-white/30 shadow-2xl hover:scale-105 transition-transform duration-500">
            ...
            {slide.secondaryImage && (
              <div className="relative animate-fade-in-up delay-600">
                ...
                <div className="relative bg-white/20 backdrop-blur-md rounded-xl lg:rounded-2xl overflow-hidden border border-white/30 shadow-xl hover:scale-105 transition-transform duration-500">
          ...
          <div className="relative max-w-md mx-auto lg:max-w-none animate-fade-in-up delay-400">
            <div className="absolute inset-0 bg-gradient-to-br from-amber-200/30 to-orange-200/30 rounded-2xl lg:rounded-3xl transform rotate-3 scale-105"></div>
            <div className="relative bg-white/30 backdrop-blur-md rounded-2xl lg:rounded-3xl overflow-hidden border border-white/40 shadow-2xl hover:scale-105 transition-transform duration-500">
  ...
  const CenteredLayout = ({ slide }) => (
    <div className="text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className={`space-y-6 lg:space-y-8 mb-8 lg:mb-12 transition-all duration-700 ${isTransitioning ? 'opacity-0 translate-y-8' : 'opacity-100 translate-y-0'}`}>
        <div className="inline-flex items-center px-4 lg:px-6 py-2 lg:py-3 rounded-full bg-gradient-to-r from-amber-100 to-orange-100 backdrop-blur-md text-amber-800 border border-amber-200 hover:scale-105 transition-transform duration-300 animate-fade-in-up">
          <Shield className="w-4 lg:w-5 h-4 lg:h-5 mr-2 lg:mr-3 text-amber-700 animate-pulse" />
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-7xl xl:text-8xl font-bold">
          <span className="block text-gray-800 mb-2 lg:mb-4 animate-fade-in-up delay-200">{slide.title}</span>
          <span className="block bg-gradient-to-r from-amber-600 via-orange-600 to-yellow-600 bg-clip-text text-transparent animate-fade-in-up delay-400">
            {slide.subtitle}
          </span>
        </h1>

        <p className="text-base sm:text-lg lg:text-xl text-gray-700 leading-relaxed max-w-2xl lg:max-w-3xl mx-auto animate-fade-in-up delay-600">
          {slide.description}
        </p>

        <div className="flex flex-col sm:flex-row gap-4 lg:gap-6 justify-center">
          <button className="px-8 lg:px-10 py-4 lg:py-5 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-semibold rounded-xl lg:rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center group animate-fade-in-up delay-800">
            <Zap className="w-5 lg:w-6 h-5 lg:h-6 mr-2 lg:mr-3 group-hover:rotate-12 transition-transform" />
            Order Now
          </button>
          <button className="px-8 lg:px-10 py-4 lg:py-5 border-2 border-amber-300 text-amber-800 font-semibold rounded-xl lg:rounded-2xl hover:bg-amber-50 transition-all duration-300 flex items-center justify-center hover:scale-105 animate-fade-in-up delay-1000">
      ...
      <div className={`relative transition-all duration-700 delay-200 ${isTransitioning ? 'opacity-0 scale-90' : 'opacity-100 scale-100'}`}>
        <div className="relative mx-auto max-w-xs sm:max-w-md lg:max-w-lg animate-fade-in-up delay-400">
  ...
  const MosaicLayout = ({ slide }) => (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-8 items-start pt-8 md:pt-0">
        ...
        >
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-rose-100 to-pink-100 backdrop-blur-md text-rose-700 border border-rose-200 premium-wellness-btn hover:scale-105 transition-transform duration-300 animate-fade-in-up">
            <Star className="w-4 h-4 mr-2 text-rose-600 animate-pulse" />
            <span className="text-sm font-semibold">PREMIUM WELLNESS</span>
          </div>

          <h1 className="text-4xl lg:text-6xl font-bold animate-fade-in-up delay-200">
          ...
          <p className="text-lg text-gray-600 leading-relaxed animate-fade-in-up delay-400">
            {slide.description}
          </p>
          ...
          <div className="space-y-4 animate-fade-in-up delay-600">
            ...
            <div className="grid grid-cols-2 gap-4 text-center">
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-3 border border-white/40 hover:scale-105 transition-transform duration-300">
        ...
        >
          <div className="grid grid-cols-2 gap-6 h-96">
            {/* Large Image */}
            <div className="row-span-2 relative animate-fade-in-up delay-400">
              <div className="absolute inset-0 bg-gradient-to-br from-rose-400/20 to-pink-400/20 rounded-2xl transform rotate-1"></div>
              <div className="relative h-full bg-white/20 backdrop-blur-md rounded-2xl overflow-hidden border border-white/30 shadow-xl hover:scale-105 transition-transform duration-500">
            ...
            <div className="relative animate-fade-in-up delay-600">
              ...
              <div className="relative h-full bg-white/20 backdrop-blur-md rounded-xl overflow-hidden border border-white/30 shadow-lg hover:scale-105 transition-transform duration-500">
  ...
  return (
    <>
      <div
        className={`relative min-h-content overflow-hidden md:pt-16 pt-8 bg-gradient-to-br ${currentSlideData.bgColor} transition-all duration-1000 ease-in-out`}
      >
        {/* Background Pattern */}
        ...
        <div className="relative z-10 flex items-center min-h-[80vh] px-4 py-6 md:py-12 hero-content-container responsive-hero">
          ...
          <div className="flex space-x-3">
            {slides.map((_, index) => (
              <button
                ...
                className={`w-4 h-4 rounded-full transition-all duration-500 hover:scale-125 ${index === currentSlide

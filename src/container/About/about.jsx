      ...
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:grid md:grid-cols-2 gap-10 items-start justify-center">
        ...
        <div className="text-center md:text-left">
          ...
          <BlurFade delay={0.5} inView direction="up">
            <p className="text-gray-600 leading-relaxed mb-4">
              Welcome to Rainbow Juice & Snack Centre – your destination for
              refreshing juices, delightful snacks, and great vibes. We are
              passionate about serving freshly made fruit juices, milkshakes,
              and traditional Indian snacks that taste like home.
            </p>
          </BlurFade>
          <BlurFade delay={0.5} inView direction="up">
            <p className="text-gray-600 leading-relaxed mb-6">
              With a focus on quality and hygiene, every item is prepared using
              the finest ingredients. Whether you're craving a tangy chaat or a
              fruity delight, we’ve got you covered!
            </p>
          </BlurFade>
          <BlurFade delay={0.5} inView direction="up">
        ...
        <div className="relative grid grid-cols-2 gap-2 md:gap-4 w-full max-w-sm md:max-w-xl mx-auto">
          <BlurFade delay={0.15} inView direction="up">
            <div
              className="bg-white p-[6px] border-[4px] border-gradient-to-r from-red-500 via-orange-500 via-yellow-500 via-green-500 via-blue-500 via-indigo-500 to-purple-500 rounded-md shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl group cursor-pointer"
              style={{
                background:
                  "linear-gradient(white, white), linear-gradient(45deg, #ef4444, #f97316, #eab308, #22c55e, #3b82f6, #6366f1, #a855f7)",
                backgroundClip: "padding-box, border-box",
                border: "4px solid transparent",
              }}
            >
              <div className="bg-[#7b0022] rounded-md shadow-lg overflow-hidden">
                <figure className="w-100 h-[125px] md:w-100 md:h-[200px]">
                  <img
                    src={burger}
                    alt="Drink 1"
                    className="w-full h-full object-cover mx-auto rounded-md transition-all duration-300 group-hover:scale-110 group-hover:rotate-2"
                  />
                </figure>
              </div>
            </div>
          ...
          <BlurFade delay={0.25} inView direction="up">
            ...
            >
              <div className="bg-[#e63946] rounded-md shadow-lg overflow-hidden">
                <figure className="w-100 h-[125px]  md:w-100 md:h-[200px]">
                  <img
                    src={dosa}
                    alt="Drink 2"
          ...
          <BlurFade delay={0.35} inView direction="up">
            ...
            >
              <div className="bg-[#ff3c38] rounded-md shadow-lg overflow-hidden">
                <figure className="w-100 h-[125px]  md:w-100 md:h-[200px]">
                  <img
                    src={fries}
                    alt="Drink 3"
          ...
          <BlurFade delay={0.45} inView direction="up">
            ...
            >
              <div className="bg-[#b71c1c] rounded-md shadow-lg overflow-hidden">
                <figure className="w-100 h-[125px] md:w-100 md:h-[200px]">
                  <img
                    src={frankie}
                    alt="Drink 4"

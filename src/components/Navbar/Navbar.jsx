...
import { Menu, X, Sparkles, Star, Play, ChevronDown,Heart, ArrowRight } from "lucide-react";
import "./Navbar.css";
...
const Navbar = () => {
  ...
  const navItems = ['Home', 'About', 'Menu', 'Services', 'Contact'];
 ...
 {/* Infinity Scrolling Header - Rainbow Colors */}
      {/* <div className={`bg-amber-50 py-2.5 overflow-hidden relative shadow-sm transition-all duration-300 ${
      ...
      <div className={`${isScrolled ? 'h-20' : 'h-28'} transition-all duration-500`}></div>
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${
                        ...
                        <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-100 py-2 transform transition-all duration-200 ease-out">
                          {menuCategories.map((category, idx) => (
                            <a
                              ...
                              className="block px-4 py-2 text-gray-700 hover:text-orange-600 hover:bg-orange-50 transition-colors duration-200"
                            >
                              {category}
                            </a>
                          ))}
        ...
        {toggleMenu && (
          <div className="fixed inset-0 z-50 lg:hidden">
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm" onClick={() => setToggleMenu(false)}></div>
            <div className="fixed top-0 right-0 w-80 h-screen bg-white shadow-2xl transform transition-transform duration-300 ease-out flex flex-col">
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-orange-50 to-red-50">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <span className="text-gray-800 font-bold text-lg">Rainbow</span>
